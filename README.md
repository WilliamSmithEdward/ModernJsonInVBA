...
\
Take nested or complex API payloads and easily convert them into normalized Excel tables, with parent keys preserved and support for formulas or raw JSON, XML, CSV, or scalar value injection.
